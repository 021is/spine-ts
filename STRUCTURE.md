...
│   │   ├── env.ts                   defineEnv from @021/spine-env
│   │   ├── auth.ts                  re-exports from @021/spine-auth
...
│   └── i18n/                        Translation runtime + per-feature catalogs (see @021/spine-i18n)
├── tests/
...
|---|---|---|
| Response envelope + exceptions | `@021/spine-errors` | `021-platform-errors` |
| Auth (JWKS verify) | `@021/spine-auth` | `021-platform-auth` (SecurityConfigBase) |
| HTTP client + resilience | `@021/spine-http` | `021-platform-rest` (WebClient + Resilience4j) |
| Telemetry | `@021/spine-telemetry` | `021-platform-otel` |
| Env loading | `@021/spine-env` | `021-platform-env` |
| i18n | `@021/spine-i18n` | `021-platform-locale` |
| NATS jobs | `@021/spine-jobs` | `021-platform-nats` |
| Rate-limit | `@021/spine-ratelimit` | `021-platform-ratelimit` |
...
- **`@021/spine-*` cross-package deps via `workspace:*`** during dev; Changesets publishes pinned ranges.
